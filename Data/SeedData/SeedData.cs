    ...
    public static class SeedData
    {
        public static async Task InitializeAsync(IServiceProvider serviceProvider)
        {
            ...
            var tags = new List<Tag>
            {
                ...
                new Tag { Name = "Entity Framework", Url = "entity-framework", Color = TagColors.Purple, IsActive = true, CreatedAt = DateTime.UtcNow },
                ...
                new Tag { Name = "CSS", Url = "css", Color = TagColors.Purple, IsActive = true, CreatedAt = DateTime.UtcNow },
                new Tag { Name = "React", Url = "react", Color = TagColors.Purple, IsActive = true, CreatedAt = DateTime.UtcNow },
                ...
                new Tag { Name = "Docker", Url = "docker", Color = TagColors.Purple, IsActive = true, CreatedAt = DateTime.UtcNow },
